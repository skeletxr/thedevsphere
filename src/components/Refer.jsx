...
const Refer = () => {
  ...
  return (
    <>
      ...
      <div style={{ backgroundColor: "#1D232A" }} className="flex min-h-[65vh] flex-col items-center justify-center mt-6  max-w-[75vw] mx-auto lg:mt-20">
      ...
      <section style={{ backgroundColor: "#1D232A" }} className="bg-gray-900 max-w-[85vw] mx-auto">
      ...
      <section>
        <div style={{ backgroundColor: "#1D232A" }} className="flex flex-col items-center justify-center max-h-[50vh] px-4 bg-gray-900 text-white">
