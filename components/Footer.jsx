...
const Footer = ({scrollToFeatures, scrollToTestimonials,  scrollToPrice, scrollToRequestCallBack, classs}) => {
  ...
  <nav>
          <h6 className="footer-title text-gray-400">pages</h6>
          <div
            onClick={() =>
              pathName == "/" &&
              scrollToFeatures.current.scrollIntoView({ behavior: "smooth" })
            }
            className="link text-gray-400 link-hover"
          >
            Features
          </div>
          <div
        ...
        <nav>
          <h6 className="footer-title text-gray-400 ">TheDevSphere</h6>
          <div className="link link-hover text-gray-400 ">About us</div>
          <Link
           href="/ContactUs"
            className="link text-gray-400 link-hover"
          >
        ...
        <nav>
          ...
          <Link href="/Terms&Condition" className="link text-gray-400 link-hover">
            Terms of use
          </Link>
          <Link href="/PrivacyPolicy" className="link link-hover text-gray-400">
            Privacy policy
          </Link>
        </nav>
      </footer>
