   ...
   <>
        ...
        >
          ...
          <motion.span
            ...
            className="text-neutral-700 cursor-pointer dark:text-neutral-200 text-sm group-hover/sidebar:translate-x-1 transition duration-150 whitespace-pre inline-block !p-0 !m-0"
          >
            {link.label}
          </motion.span>
        </div>
