...
export function SidebarDemo() {
  const links = [
    {
      ...
      href: "/",
      icon: (
        <IconHomeShare stroke={2}  className="text-neutral-700 dark:text-neutral-200 h-5 w-5 flex-shrink-0" />
      ),
    },
    {
      label: "Courses",
  ...
  return (
    (<div
      ...
      <SidebarBody className="justify-between gap-10" style={{ background: "black" }} >
          <div className="flex flex-col flex-1 overflow-y-auto overflow-x-hidden background-color:black  " style={{ background: "black" }}>
            {/* {open ? <Logo /> : <LogoIcon />} */}
...
const Dashboard = () => {
  return (
    (<div className="flex flex-1 ">
      <div
        className="p-2 md:p-10 border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-black flex flex-col gap-2 flex-1 w-full h-full overflow-y-auto">
        ...
        <div className="flex gap-2 flex-1">
         ...
         <div className="w-full ">
          <h1 className="text-gray-400 text-5xl font-sans">Full Stack Web Development</h1>
        </div>
