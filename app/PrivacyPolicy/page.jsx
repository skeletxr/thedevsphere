  ...
  return (
    <div className="container mx-auto my-10 p-6 bg-gray-50 shadow-lg rounded-lg">
      ...
      <p className="text-gray-700 mb-6">
        <strong>TheDevSphere</strong> (referred to as "we," "our," or "us")
        values your privacy and your personal information. This Privacy Policy
        outlines how we collect, use, and store the information you provide
        while using our website and services. By accessing or using our website,
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc ml-6 text-gray-700">
          <li>
            To provide and manage our services, including enrollment and course
            delivery.
          </li>
          <li>To process payments and issue invoices or receipts.</li>
          <li>
            To communicate updates, reminders, or important course-related
            notifications.
          </li>
          <li>
            To enhance user experience by analyzing website usage and feedback.
          </li>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc ml-6 text-gray-700">
          <li>
            ...
            trusted third-party providers who assist in hosting, payment
            processing, or delivering services. These parties are obligated to
            maintain confidentiality.
          </li>
          <li>
            <strong>Legal Compliance:</strong> We may disclose information if
            required by law, court orders, or to protect our rights and
            property.
          </li>
          <li>
            <strong>Business Transfers:</strong> In the event of a merger,
            acquisition, or sale, your information may be transferred to the new
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700">
          ...
          Afterward, data will be securely deleted or anonymized.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700">
          Our website may use cookies to enhance functionality and gather
          analytical data. You can manage cookie preferences through your
          browser settings.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700">
          No online platform can guarantee complete security. However, we
          implement industry-standard measures to protect your data.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700">
          ...
          <strong>contact.thedevsphere@gmail.com</strong>.
        </p>
      </section>
